            ...
            <div className="xl:col-span-3 xl:row-span-2 xl:pb-0">
              <div className="lg:flex">
                ...
                <div className="sticky top-0 hidden h-screen pt-6 pb-8 pl-6 lg:block xl:pl-16">
                  ...
                  <div>
                    <h3 className="mb-1 font-bold">🚀 FREE NestJS Cheat Sheet!</h3>
                    <p className="text-sm leading-6 text-gray-600">
                      It’s packed with practical tips and best practices to make you a more
                      productive developer with NestJS.
                    </p>
                    <ConvertKitForm
                      buttonText="Get cheat sheet"
                      formId="3543469"
                      redirect="nestjs-cheat-sheet"
                      sideForm={false}
                    />
                  </div>
                </div>
