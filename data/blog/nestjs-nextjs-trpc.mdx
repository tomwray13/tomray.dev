...
lastmod: '2023-06-18'
draft: false
summary: Discover how to create a fully type-safe pnpm monorepo using NestJS and NextJS. This comprehensive tutorial covers the integration of tRPC as the API layer, providing end-to-end type safety for your full-stack TypeScript application.
images: ['/static/images/nestjs-nextjs-trpc/banner.png']
---

In this tutorial, we're going to start from scratch and build a full-stack, end-to-end type-safe pnpm monorepo with [NestJS](https://nestjs.com/), [NextJS 13](https://nextjs.org/docs) (using the new `/app` directory) & [tRPC](https://trpc.io/).
...
Before diving in, it's worth exploring why using tRPC with NestJS and NextJS is a good idea.
