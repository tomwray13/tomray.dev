...
That's a little beyond this scope of this tutorial (you'd be using [async configuration](https://docs.nestjs.com/techniques/caching#async-configuration)), but I'll be publishing a more in-depth tutorial on how to do this in the future.
